    ...
    return (
        <div className="container" style={{ marginTop: '4rem', textAlign: 'center' }}>
            ...
            <div className="animate-fade-in mobile-stack" style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap', animationDelay: '0.2s', opacity: 0 }}>
                <a href="/farmer" className="glass-panel" style={{ padding: '2rem', width: '100%', maxWidth: '300px', textDecoration: 'none', transition: 'transform 0.3s ease' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
                ...
                <a href="/consumer" className="glass-panel" style={{ padding: '2rem', width: '100%', maxWidth: '300px', textDecoration: 'none', transition: 'transform 0.3s ease' }} onMouseOver={(e) => e.currentTarget.style.transform = 'translateY(-10px)'} onMouseOut={(e) => e.currentTarget.style.transform = 'translateY(0)'}>
                    <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🛒</div>
